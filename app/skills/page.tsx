...
export default function Skills() {
    ...
    const animation = {
        ...
        enter:  (i: number) => ({opacity:1, scale:1, transition: {duration: 0.3, ease: easeInOut,  delay: 0.15 * i}})
      }
  ...
  return (
    ...
    <motion.h2 initial={{ y:100, opacity: 0, scale:0.5 }} animate={{ y:0, opacity:1, scale:1}} transition={{ ease: "easeInOut", duration: 0.15}}  className="text-4xl font-semibold">My skills</motion.h2>
